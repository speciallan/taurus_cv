...
from taurus_cv.models.fsaf.utils import np_utils
...
def get_detections(boxes, scores, predict_labels, num_classes, score_shreshold=0.05, max_boxes_num=100):
    ...
    for image_idx in range(num_images):
        ...
        # 合并边框和得分
        cur_detections = np.concatenate([cur_boxes, cur_scores], axis=2)
...
def get_annotations(image_info_list, num_classes, cordinate_order=False):
    """
    获取所有的编著
